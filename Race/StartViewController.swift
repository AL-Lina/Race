...
class StartViewController: UIViewController {
    ...
    func setUpScreen() {
        ...
        startButton.frame = CGRect(x: 125, y: 200, width: 150, height: 70)
        view.addSubview(startButton)
        addButton.frame = CGRect(x: 125, y: 300, width: 150, height: 70)
        ...
        addButton.addTarget(self, action: #selector(goToRecordsScreen), for: .primaryActionTriggered)
